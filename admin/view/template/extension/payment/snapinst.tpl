   ...
   <div class="panel panel-default">
	...
	<div class="form-group sensitive">
      <label class="col-sm-2 control-label" for="input-redirect"><span data-toggle="tooltip" title="<?php echo $help_redirect; ?>"><?php echo $entry_redirect; ?></span></label>
		<div class="col-sm-10">
		 <select name="snapinst_redirect" id="input-redirect" class="form-control">
		  <?php $options = array('0' => $text_disabled, '1' => $text_enabled) ?>
		   <?php foreach ($options as $key => $value): ?>
		    <option value="<?php echo $key ?>" <?php if ($key == $snapinst_redirect) echo 'selected' ?> ><?php echo $value ?></option>
		   <?php endforeach ?>
		  </select>
		</div>
	...
	<div class="form-group">
      ...
      <div class="col-sm-10">
		 <select name="snapinst_status_success" id="input-success-status" class="form-control">
		  <?php foreach ($order_statuses as $order_status) { ?>
		  	<?php if ($order_status['order_status_id'] == $snapinst_status_success) { ?>
	...
	<div class="form-group">
      ...
      <div class="col-sm-10">
		 <select name="snapinst_status_pending" id="input-pending-status" class="form-control">
		  <?php foreach ($order_statuses as $order_status) { ?>
		  	<?php if ($order_status['order_status_id'] == $snapinst_status_pending) { ?>
		  		<option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
		  	<?php } else { ?>
		  		<option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name'];?></option>
		  	<?php } ?>
	...
	<div class="form-group">
      ...
      <div class="col-sm-10">
		 <select name="snapinst_status_failure" id="input-failure-status" class="form-control">
		  <?php foreach ($order_statuses as $order_status) { ?>
		  	<?php if ($order_status['order_status_id'] == $snapinst_status_failure) { ?>
		  		<option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
		  	<?php } else { ?>
		  		<option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name'];?></option>
		  	<?php } ?>
